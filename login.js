/* ==========================================================
   ...
   (usa leerLista, guardarLista, leerEstadoIntentos,
   guardarEstadoIntentos, marcarCampoInvalido, limpiarCampoInvalido,
   limpiarErroresFormulario, activarLimpiezaAlEscribir,
   esCorreoValido, mostrarMensaje y las constantes
   MAXIMO_INTENTOS / TIEMPO_BLOQUEO_MS).
   ========================================================== */
